...
\begin{itemize}
    \item \para{Co-occurrence Matrix Construction.}
    ...
    \item \para{Joint Probability Calculation.}
    ...
    \item \para{Marginal Probability Calculation.}
...
\subsection{Evaluation of various approaches}
They compared the different approaches discussed in \Cref{subsec:methods-for-quantifying-semantic-change} on \emph{synchronic accuracy} (similarity within time-period) and \emph{diachronic validity} (semantic changes over time).
\begin{itemize}
    ...
    \begin{itemize}
        ...
        Tested whether the methods discover reasonable shifts by examining the top-10 words that changed the most from the 1900s to the 1990s according to the semantic displacement metric (\Cref{subsec:methods-for-quantifying-semantic-change}).
    \end{itemize}
