...
Among these, the distributional time series proved most insightful, as it captures the contextual usage of word.
...
The algorithm (\Cref{subsec:kulkarni-rq2}) presented in the paper computes the mean shift series as part of its approach to detect significant changes in linguistic usage over time.
